<%-- 
    Document   : District
    Created on : Jan 30, 2018, 2:49:19 PM
    Author     : G-PROJECTS
--%>
    ...
    <body>
        <form name="frmDistrict" action="District.jsp" method="POST">
            ...
            <table border="1">
                <thead>
                    <tr>
                        <th colspan="2">District Details</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="300"><select name="selState">
                    ...
                    <tr>
                        <td>District</td>
                        <td><input type="text" name="txtDistrict" value="<%=distname %>" size="40" /></td>
                    </tr>
                    <tr>
                ...
                <input type="hidden" name="hid" value="<%=distid%>"/>
                            ...
                            <table border="1">
                                <thead>
                                    <tr>
                                        <th colspan="3">District Details</th>                                       
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
