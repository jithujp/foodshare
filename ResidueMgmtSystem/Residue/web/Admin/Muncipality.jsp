<%-- 
    Document   : Muncipality
    Created on : Jan 30, 2018, 4:06:09 PM
    Author     : G-PROJECTS
--%>
    ...
    <body>
        <form name="frmMuncipality" action="Muncipality.jsp" method="POST">
            ...
            <table border="1">
                <thead>
                    <tr>
                        <th colspan="2">Muncipality Details</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="300"><select name="selState" onchange="selectDistrict(this.value)">
                    ...
                    <tr>
                        <td>Muncipality</td>
                        <td><input type="text" name="txtMuncipality" value="<%=muncipality%>" /></td>
                    </tr>
                    <tr>
                ...
                <input type="hidden" name="hid" id="hid" value="<%=munid%>"/>
                            ...
                            <table border="1">
                                <thead>
                                    <tr>
                                        <th colspan="3">Muncipality Details</th>                                        
                                    </tr>
                                </thead>
                                <tbody>
                                    <%
